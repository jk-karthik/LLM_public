...
### Notebook: Testing Ollama Functionality
# Notebook: Testing Ollama Functionality **Objective.** Look for all customizable features in generative process and conclude if it meets the requirements for the project use case <!-- **Data.** <sources, date range, N obs, key filters>   --> <!-- **Method.** <models/algorithms + key hyperparams>   --> <!-- **Key Results.** <bullet metrics with numbers + links to figs> **Takeaways.** <what to do with the result>
